...
namespace Southport.Extensions.HttpClient.Resilient.HttpClientExtensions
{
    ...
    public static class HttpClientExtensionGets
    {
        ...
        public static async Task<HttpResponseMessage> GetResilientAsync(this System.Net.Http.HttpClient httpClient, string url, int maxRetries = 2, List<HttpStatusCode> retryStatusCodes = null)
        {
        ...
        public static async Task<TResponseType> GetResilientAsync<TResponseType>(this System.Net.Http.HttpClient httpClient, string url, int maxRetries = 2, List<HttpStatusCode> retryStatusCodes = null) where TResponseType : class
        {
        ...
        public static async Task<TResponseType> GetResilientAsync<TResponseType>(this System.Net.Http.HttpClient httpClient, string url, CancellationToken cancellationToken, int maxRetries = 2, List<HttpStatusCode> retryStatusCodes = null) where TResponseType : class
        {
        ...
        public static async Task<HttpResponseMessage> GetResilientAsync(this System.Net.Http.HttpClient httpClient, string url, CancellationToken cancellationToken, int maxRetries = 2, List<HttpStatusCode> retryStatusCodes = null)
        {
