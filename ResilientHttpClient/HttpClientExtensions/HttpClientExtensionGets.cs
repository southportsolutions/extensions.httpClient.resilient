...
namespace Southport.ResilientHttp
{
    ...
    public static class HttpClientExtensionGets
    {
        ...
        public static async Task<HttpResponseMessage> GetResilientAsync(this HttpClient httpClient, string url, int maxRetries = 2, List<HttpStatusCode> retryStatusCodes = null)
        {
        ...
        public static async Task<TResponseType> GetResilientAsync<TResponseType>(this HttpClient httpClient, string url, int maxRetries = 2, List<HttpStatusCode> retryStatusCodes = null) where TResponseType : class
        {
        ...
        public static async Task<TResponseType> GetResilientAsync<TResponseType>(this HttpClient httpClient, string url, CancellationToken cancellationToken, int maxRetries = 2, List<HttpStatusCode> retryStatusCodes = null) where TResponseType : class
        {
        ...
        public static async Task<HttpResponseMessage> GetResilientAsync(this HttpClient httpClient, string url, CancellationToken cancellationToken, int maxRetries = 2, List<HttpStatusCode> retryStatusCodes = null)
        {
